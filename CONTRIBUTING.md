...
This outlines how to propose a change to pal. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("simonpcouch/pal", fork = TRUE)`.
...
Please note that the pal project is released with a [Contributor Code of
Conduct](https://simonpcouch.github.io/gander/CODE_OF_CONDUCT.md). By
