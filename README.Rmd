...
#| label: gander-demo
#| echo: false
#| fig-alt: "A screencast demonstrating usage. In an RStudio session, I iteratively build a plot based on the stackoverflow dataset from modeldata by typing plain-english instructions."
