...
The gander package allows [ellmer](https://ellmer.tidyverse.org) chats to interface directly with your RStudio and Positron sessions. After (optionally) selecting some code, press the keyboard shortcut you've chosen to trigger the assistant (we suggest `Ctrl+Cmd+G`, as in "help") and write your request.
