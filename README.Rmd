...
```{r}
#| echo: false
#| fig.alt: "A screencast demonstrating usage. In an RStudio session, I iteratively build a plot based on the mtcars dataset by typing plain-english instructions."
knitr::include_graphics("https://github.com/user-attachments/assets/563f4670-860a-4f8f-a087-41c28381b977")
```
