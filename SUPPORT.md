# Getting help with pal

Thanks for using pal! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/simonpcouch/pal/issues/new).
...
requests](https://github.com/simonpcouch/pal/issues) to make sure the
